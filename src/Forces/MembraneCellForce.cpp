...
void MembraneCellForce::SetBasementMembraneParameter(double basementMembraneParameter)
{
	mBasementMembraneParameter = basementMembraneParameter;
}

double MembraneCellForce::GetBasementMembraneParameter()
{
	return mBasementMembraneParameter;
}


void MembraneCellForce::SetTargetCurvature(double targetCurvature)
{
	mTargetCurvature = targetCurvature;
}


double MembraneCellForce::GetTargetCurvature()
{
	return mTargetCurvature;
}

void MembraneCellForce::RemoveDuplicates1D(std::vector<unsigned>& rVectorWithDuplicates)
{
...
std::vector<c_vector<unsigned, 2> > MembraneCellForce::GetEpithelialGelPairs(AbstractCellPopulation<2>& rCellPopulation)
{
...
bool MembraneCellForce::DoesElementContainGhostNodes(AbstractCellPopulation<2>& rCellPopulation, unsigned elementIndex)
{
	MeshBasedCellPopulation<2>* p_tissue = static_cast<MeshBasedCellPopulation<2>*>(&rCellPopulation);
...
double MembraneCellForce::GetCurvatureFromNodePair(AbstractCellPopulation<2>& rCellPopulation, unsigned epithelialNodeIndex,
...
double MembraneCellForce::GetCurvatureFromMidpoints(AbstractCellPopulation<2>& rCellPopulation,
...
unsigned MembraneCellForce::GetNumContainingElementsWithoutGhostNodes(AbstractCellPopulation<2>& rCellPopulation, unsigned nodeIndex)
{
	MeshBasedCellPopulation<2>* p_tissue = static_cast<MeshBasedCellPopulation<2>*>(&rCellPopulation);
...
std::set<unsigned> MembraneCellForce::GetNeighbouringNodeIndices(AbstractCellPopulation<2>& rCellPopulation, unsigned nodeIndex)
{
	MeshBasedCellPopulation<2>* p_tissue = static_cast<MeshBasedCellPopulation<2>*>(&rCellPopulation);
...
bool MembraneCellForce::HasEpithelialCellDetachedFromBasementMembrane(AbstractCellPopulation<2>& rCellPopulation, unsigned nodeIndex)
{
	MeshBasedCellPopulation<2>* p_tissue = static_cast<MeshBasedCellPopulation<2>*>(&rCellPopulation);
