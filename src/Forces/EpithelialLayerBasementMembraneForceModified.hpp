#ifndef EPITHELIALLAYERBASEMENTMEMBRANEFORCEMODIFIED_HPP_
#define EPITHELIALLAYERBASEMENTMEMBRANEFORCEMODIFIED_HPP_
...
class EpithelialLayerBasementMembraneForceModified : public AbstractForce<2>
{
...
public :
     ...
     * Constructor.
     */
	EpithelialLayerBasementMembraneForceModified();
